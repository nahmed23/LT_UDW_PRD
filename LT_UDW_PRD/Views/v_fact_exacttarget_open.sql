CREATE VIEW [marketing].[v_fact_exacttarget_open] AS select h_exacttarget_open.bk_hash fact_exacttarget_open_key,
       ...
       h_exacttarget_open.dv_batch_id dv_batch_id
