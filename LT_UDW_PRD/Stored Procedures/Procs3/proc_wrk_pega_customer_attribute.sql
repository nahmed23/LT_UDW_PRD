...
begin
	...
	(
		...
		select id from dim_mdm_golden_record_customer_id_list where id_type =5 and dv_batch_id >= @load_dv_batch_id)
		union
	...
	left join
		dim_mdm_golden_record_customer_id_list 
			on  #member_details.member_id = dim_mdm_golden_record_customer_id_list.id
	where 
		dim_mdm_golden_record_customer_id_list.id_type = 5 
