...
---- Exec [reporting].[proc_PTTrainer_DSSR_ClientList_DrillThrough] '1/22/2020',238,-1
----
...
DECLARE @ReportMonthFirstOfMonthDimDateKey INT									
DECLARE @ReportMonthPriorOneDimDateKey INT										
DECLARE @ReportMonthPriorTwoDimDateKey INT										
...
DECLARE @RetentionPeriod_StartDimDateKey INT											
